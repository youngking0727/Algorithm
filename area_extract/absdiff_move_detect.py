...
# 调取函数
outt = threh('image/front_jeston_1.mp4','test.mpt',25,100)


'''
————————————————
版权声明：本文为CSDN博主「Chenyj0109」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/christina0109/article/details/94619058
'''